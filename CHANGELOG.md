...
- Rebranded from personal-os to School OS; workspace scope `@school-os/*`.

## [0.1.0] - 2026-02-10

### Added

- Initial School OS layout.

[Unreleased]: https://github.com/your-org/school-os/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/your-org/school-os/releases/tag/v0.1.0
